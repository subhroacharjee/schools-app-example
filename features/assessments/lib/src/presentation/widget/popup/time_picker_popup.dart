...
//         });
  ...
  Size _dialogSize(BuildContext context) {
    ...
    return Size(timePickerWidth + 50, timePickerHeight * textScaleFactor);
  }
...
//         );
    final bool use24HourDials = false; // hourFormat(of: timeOfDayFormat) != HourFormat.h;
    final ThemeData theme = Theme.of(context);
